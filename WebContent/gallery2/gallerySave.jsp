...
String path = "C:/Users/ITCS/Desktop/22-06-20/upload"; //파일 업로드 경로
				//서버의 업로드 경로에 대해 url 지정이 필요합니다 ->톰캣  server.xml
int size = 10*1024*1024;	//10MByte, 전송파일의 최대 크기

MultipartRequest multiRequest = new MultipartRequest(request,
					path,size,"UTF-8",
					new DefaultFileRenamePolicy());	
//DefaultFileRenmaePolicy 객체 : 업로드한 파일명이 중복될 경우 파일명 변경하는 정책을 설정.
